...
Spring Boot + MySQL 기반 백엔드 개발을 실습하며 다양한 서비스와 API 개발 경험을 쌓고 있습니다.
REST API 설계, DB 설계, 인증/인가 구현을 학습 중이며, 클린 아키텍처 적용과 확장 가능한 백엔드 서비스 구현을 목표로 하고 있습니다.
...
## 🚀 About Me
- 🔭 관심분야: Spring Boot, REST API, JWT 인증/인가, 성능 최적화  
- 🌱 학습 중: AWS, Docker, Kubernetes, CI/CD, 테스트 코드  
- 💡 목표: 확장성과 유지보수성이 높은 클린 아키텍처 기반 백엔드 구축  
- 🎯 특징: 꼼꼼함, 문제 해결을 즐김, 새로운 기술을 적극적으로 도입  
